...
const Destinations = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20 font-sans">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3 w-full lg:w-auto">
              <button
                ...
                style={{
                  backgroundColor: filter === "All" ? THEME.highlight : undefined,
                }}
              >
                All
              </button>
            ...
            <div className="relative w-full lg:w-64">
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-full text-sm focus:outline-none"
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredDestinations.map((dest) => {
            ...
            return (
              <Link to={`/destinations/${dest.slug}`} key={dest.id}>
                <div className="group relative h-96 rounded-2xl overflow-hidden shadow-lg cursor-pointer bg-gray-200">
                  <img
                    src={displayImage}
                    alt={dest.title}
          ...
          {filteredDestinations.length === 0 && (
            <div className="col-span-full text-center py-20 text-gray-500">
              <p className="text-xl mb-4">No destinations found matching your filters.</p>
              <button
                onClick={() => {
                  setSearchQuery("");
                  setFilter("All");
                ...
                className="bg-[#111827] text-white px-6 py-2 rounded-full font-bold text-sm hover:opacity-90 transition-all"
                style={{ backgroundColor: THEME.highlight }}
              >
                Reset Filters
              </button>
      ...
      {/* Footer CTA */}
      <div className="bg-white mt-20 py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <Link to="/contact">
            <button className="bg-gray-900 text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-gray-800 transition-all">
